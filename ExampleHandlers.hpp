...
public:
  ...
  PostFooAction(Params params) {
    std::cout << __FUNCTION__ << ":" << __LINE__ << " " << params.id << " "
...
class GetFoo : public CppRouter::GenericHandler {
public:
...
BOOST_FUSION_ADAPT_STRUCT(PostFooAction::Params,
                          (int, id)(CppRouter::Constraint,
                                    id_constraints)(std::string, name));

BOOST_FUSION_ADAPT_STRUCT(GetFoo::Params,
                          (int, id)(CppRouter::Constraint, id_constraints));
